...
Because this application won’t be deployed, a provided link to a walk-through video that demonstrates its functionality is [here](here). View the Screencastify video: [video](video).
